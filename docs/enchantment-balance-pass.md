...
| Drawn Steel | 1 | Physical, Mobility | First enchanting setup | Prepared combat burst | Perfect Strike | weight 2; cost 18-55; anvil 4; charge 40 ticks; ready 1.0; damage x1.25 | Katana-only. Verify the HUD remains readable, swapping weapons always clears preparation, and the opening strike feels worthwhile without becoming mandatory. |
| Distant Edge | 3 | Physical, Mobility | First enchanting setup | Spacing damage | None | weight 2; cost 14+8/55+8; anvil 4; minimum distance 3.0; ready 1.0; damage +8%/+12%/+16% | Katana-only. Verify hitbox-distance feedback on small, large, and airborne targets and ensure ordinary sword range cannot qualify through unusual scale modifiers. |
| Moonlit Reversal | 1 | Defensive, Physical | First enchanting setup | Parry counter burst | None | weight 2; cost 18-60; anvil 6; ready 1.0; damage x1.2; +6 flat posture | Katana-only and Mobs Combat-dependent. Verify one activation per successful parry, full counter-window duration, quick-attack consumption, and no activation from perfect blocks. |
