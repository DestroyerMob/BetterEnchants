...
public final class ModEnchantments {
    ...
    public static final ResourceKey<Enchantment> DISTANT_EDGE = ResourceKey.create(Registries.ENCHANTMENT, BetterEnchanting.id("distant_edge"));
    ...
    public static final ResourceKey<Enchantment> MOONLIT_REVERSAL = ResourceKey.create(Registries.ENCHANTMENT, BetterEnchanting.id("moonlit_reversal"));
