...
public final class BetterEnchantingConfig {
    ...
    static {
        ...
        ENCHANTING_MAX_BOOKSHELF_POWER = builder
                .comment("Bookshelf power used as the maximum for enhanced enchanting roll power.")
                .defineInRange("max_bookshelf_power", 15, 0, 64);
        ENCHANTING_MIN_BASE_COST = builder
                .comment("Minimum roll power generated by enhanced enchanting offers. This is driven by shelves, not player XP levels.")
                .defineInRange("min_base_cost", 1, 0, 1_000_000);
        ENCHANTING_MAX_BASE_COST = builder
                .comment("Maximum roll power generated by enhanced enchanting offers before event hooks. This is driven by shelves, not player XP levels.")
                .defineInRange("max_base_cost", 30, 1, 1_000_000);
        ENCHANTING_BASE_COST_PER_BOOKSHELF_POWER = builder
                .comment("Roll power added per bookshelf power point before the configured maximum roll power is reached.")
