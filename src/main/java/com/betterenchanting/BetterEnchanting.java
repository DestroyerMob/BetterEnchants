...
import com.betterenchanting.world.enchantment.ConductiveEnchantmentEvents;
import com.betterenchanting.world.enchantment.CurseOfReboundEnchantmentEvents;
import com.betterenchanting.world.enchantment.DrawnSteelEnchantmentEvents;
import com.betterenchanting.world.enchantment.DistantEdgeEnchantmentEvents;
import com.betterenchanting.world.enchantment.FortunesTouchEnchantmentEvents;
import com.betterenchanting.world.enchantment.FrostbiteEnchantmentEvents;
...
import com.betterenchanting.world.enchantment.HeadshotEnchantmentEvents;
import com.betterenchanting.world.enchantment.MoonlitReversalEnchantmentEvents;
...
import com.betterenchanting.world.enchantment.ResonanceEnchantmentEvents;
...
public final class BetterEnchanting {
    ...
    public BetterEnchanting(IEventBus modBus, ModContainer modContainer) {
        ...
        NeoForge.EVENT_BUS.addListener(CinderstepEnchantmentEvents::applyCinderstep);
        NeoForge.EVENT_BUS.addListener(EventPriority.LOWEST, ConductiveEnchantmentEvents::chargeFromLightning);
        NeoForge.EVENT_BUS.addListener(EventPriority.LOWEST, ConductiveEnchantmentEvents::redirectLightning);
        NeoForge.EVENT_BUS.addListener(ConductiveEnchantmentEvents::tickChargedPlayer);
        NeoForge.EVENT_BUS.addListener(ConductiveEnchantmentEvents::clearOnDeath);
        NeoForge.EVENT_BUS.addListener(ConductiveEnchantmentEvents::clearOnLogout);
        NeoForge.EVENT_BUS.addListener(CurseOfReboundEnchantmentEvents::reflectPlayerDamage);
        NeoForge.EVENT_BUS.addListener(FrostbiteEnchantmentEvents::preventFrozenEffectDamage);
        NeoForge.EVENT_BUS.addListener(FrostbiteEnchantmentEvents::applyFrostbite);
        NeoForge.EVENT_BUS.addListener(FrostbiteEnchantmentEvents::keepFrozenEntitiesFrozen);
        ...
        NeoForge.EVENT_BUS.addListener(DrawnSteelEnchantmentEvents::prepareAttack);
        NeoForge.EVENT_BUS.addListener(DrawnSteelEnchantmentEvents::applyDamage);
        NeoForge.EVENT_BUS.addListener(DrawnSteelEnchantmentEvents::finishAttack);
        NeoForge.EVENT_BUS.addListener(DistantEdgeEnchantmentEvents::prepareAttack);
        NeoForge.EVENT_BUS.addListener(DistantEdgeEnchantmentEvents::applyDamage);
        NeoForge.EVENT_BUS.addListener(EventPriority.LOWEST, DistantEdgeEnchantmentEvents::finishAttack);
        NeoForge.EVENT_BUS.addListener(MoonlitReversalEnchantmentEvents::prepareAttack);
        NeoForge.EVENT_BUS.addListener(MoonlitReversalEnchantmentEvents::applyDamage);
        NeoForge.EVENT_BUS.addListener(EventPriority.LOWEST, MoonlitReversalEnchantmentEvents::finishAttack);
